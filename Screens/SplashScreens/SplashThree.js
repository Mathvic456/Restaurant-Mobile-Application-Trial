    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.ImageHolder}>
                <Image source={Two} style={{height:'100%',width:'100%',}}/>
            </View>
            <View style={styles.TextContainer}>
                <Text style={{fontSize:25,fontWeight:'bold'}}>Get Ready to go out</Text>
                <Text style={{fontSize:20,fontWeight:'normal'}}>Get your meals and be ready for</Text>
                <Text style={{fontSize:20,fontWeight:'normal'}}>work in minutes</Text>
